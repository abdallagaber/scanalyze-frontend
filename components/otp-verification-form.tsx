...
export function OtpVerificationForm({ formData, updateFormData, onNext, onPrev }: OtpVerificationFormProps) {
  ...
  // In a real app, you would implement this to resend the OTP
    ...
    <Card className="scanalyze-card">
      <CardContent className="pt-6">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-xl font-semibold scanalyze-heading">Verify Your Phone Number</h2>
          <div className="flex items-center mt-2 mb-4">
            <p className="text-sm text-muted-foreground">We've sent a verification code to your WhatsApp</p>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormControl>
                    <div className="flex justify-center gap-2">
                      {Array.from({ length: 6 }, (_, index) => {
                        ...
                        const digit = index < otpValue.length ? otpValue[index] : ""
                          ...
                          <input
                            ...
                            onKeyDown={(e) => {
                              ...
                              if (e.key === "Backspace") {
                                ...
                                if (index < otpArray.length && otpArray[index]) {
                                  otpArray[index] = ""
                                  field.onChange(otpArray.join(""))
                                }
                            ...
                            onPaste={(e) => {
                              ...
                              if (pastedData.match(/^\d+$/)) {
                                ...
                                const nextEmptyIndex = otpArray.findIndex((d) => d === "")
            ...
            <div className="flex gap-3 pt-2">
              <Button type="button" variant="outline" onClick={handlePrev} className="flex-1 scanalyze-button-outline">
                Back
              </Button>
